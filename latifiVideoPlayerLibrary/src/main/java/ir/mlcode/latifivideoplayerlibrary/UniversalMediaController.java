package ir.mlcode.latifivideoplayerlibrary;
...
//    private boolean mFullscreenEnabled = false;
    ...
    private View mBackButton;// دکمه برگشت
    ...
    private void initControllerView(View v) {
        ...
        if (mCenterPlayButton != null) {//پخش را مجدداً شروع کنید
            mCenterPlayButton.setOnClickListener(mCenterPlayListener);
        }

        if (mBackButton != null) {//دکمه برگشت فقط در حالت تمام صفحه قابل مشاهده است
    ...
    //اگر در حال نمایش است,ناپدیدش کن
    ...
    //دکمه برگشت فقط در حالت تمام صفحه
...
//        super.setEnabled(enabled);
        ...
        mBackButton.setEnabled(true);// دکمه بازگشت در گوشه بالا سمت راست همیشه در حالت تمام صفحه در دسترس است.
    }
